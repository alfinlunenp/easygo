...
class RegOtp extends StatefulWidget {
  String email;
  RegOtp({super.key, required this.email});

  @override
  State<RegOtp> createState() => _OtpState();
}

class _OtpState extends State<RegOtp> {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    'EMAIL VERIFICATION',
                    style: poppinscaps.copyWith(fontSize: 24),
                  ...
                  GlobalButton(
                    ...
                    ontap: _buttonLoading
                        ...
                        : () {
                            ...
                            PostFunctions().verifyRegistrationOtp(
                              context,
                              widget.email,
                              otp,
                  ...
                  //           Text('Don’t receive the code ?' , style: normalgrey,  overflow: TextOverflow.ellipsis,
                  //         maxLines: 1,),
                  // GestureDetector(
                  ...
                  //   startCountdown();
                  //   PostFunctions().forgotpassword(context,widget.email);
